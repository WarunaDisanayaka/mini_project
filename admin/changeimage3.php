...
move_uploaded_file($_FILES["img2"]["tmp_name"],"img/vehicleimages/".$_FILES["img3"]["name"]);
$sql="UPDATE cars SET Vimage3='$vimage2' where id='$id'";
...
<div class="form-group">
												...
												<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 FROM cars WHERE cars.id='$id'";
$res=mysqli_query($con,$sql);
